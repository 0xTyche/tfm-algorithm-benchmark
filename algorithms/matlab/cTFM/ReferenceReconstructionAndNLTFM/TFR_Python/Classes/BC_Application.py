...
#####################################################################################
# BCApplication Class                                                               #
# This Class applies boundary conditions to the ABAQUS FEM model for the NLTFM     #
# computation. It handles displacement BCs derived from the measured bead           #
# displacements at the substrate boundary.                                          #
#####################################################################################
