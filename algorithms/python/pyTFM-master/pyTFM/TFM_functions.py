...
#    u, v, mask = openpiv.validation.sig2noise_val(u, v, sig2noise, threshold=1.05)
    mask = openpiv.validation.sig2noise_val(sig2noise, threshold=1.05)
    u[mask] = np.nan
    v[mask] = np.nan
    ...
    # OpenPIV>=0.25 requires a `flags`/mask argument for outlier replacement.
    # u, v = openpiv.filters.replace_outliers(u, v, method='localmean', max_iter=10, kernel_size=2)
    u, v = openpiv.filters.replace_outliers(u, v, mask, method='localmean', max_iter=10, kernel_size=2)
